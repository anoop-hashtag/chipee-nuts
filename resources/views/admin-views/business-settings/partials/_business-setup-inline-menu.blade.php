<div class="mt-5 mb-5">
    <div class="inline-page-menu my-4">
        <ul class="list-unstyled">
            ...
            {{-- <li class="{{Request::is('admin/business-settings/restaurant/packing-fee-setup')? 'active' : ''}}"><a href="{{route('admin.business-settings.restaurant.packing-fee-setup')}}">{{translate('Packing_Fee_Setup')}}</a></li> --}}
